...
function Upload() {
            ...
            if (selectedFile.size / 1000 > 10 * 1024) {
                ...
                try {
                    ...
                    const res = await axios.post(
                        "https://easy-share-backend-for-netlify.onrender.com/api/files",
                        formData,
                        {
                            headers: {
    ...
    const sendEmail = async(e) =>{
        e.preventDefault()
        try {
            const res = await axios.post('https://easy-share-backend-for-netlify.onrender.com/api/files/send',{uuid,emailTo,emailFrom})
